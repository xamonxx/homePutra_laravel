                        ...
                        <div class="order-2 lg:order-1">
                            ...
                            <div class="mt-6 sm:mt-8 md:mt-10">
                                ...
                                <div class="flex items-center gap-2 sm:gap-3">
                                    ...
                                    <a href="{{ $settings['instagram_url'] }}" target="_blank" class="w-9 sm:w-10 md:w-11 h-9 sm:h-10 md:h-11 rounded-lg sm:rounded-xl bg-white/5 border border-gray-700/50 flex items-center justify-center text-gray-400 hover:text-primary hover:border-primary/50 hover:scale-110 transition-all">
                                        <span class="material-symbols-outlined text-base sm:text-lg md:text-xl">photo_camera</span>
                                    </a>
                                    @endif
                                    @if(!empty($settings['facebook_url']))
                                    <a href="{{ $settings['facebook_url'] }}" target="_blank" class="w-9 sm:w-10 md:w-11 h-9 sm:h-10 md:h-11 rounded-lg sm:rounded-xl bg-white/5 border border-gray-700/50 flex items-center justify-center text-gray-400 hover:text-primary hover:border-primary/50 hover:scale-110 transition-all">
                                        <span class="material-symbols-outlined text-base sm:text-lg md:text-xl">thumb_up</span>
                                    </a>
                                    @endif
                                    @if(!empty($settings['youtube_url']))
                                    <a href="{{ $settings['youtube_url'] }}" target="_blank" class="w-9 sm:w-10 md:w-11 h-9 sm:h-10 md:h-11 rounded-lg sm:rounded-xl bg-white/5 border border-gray-700/50 flex items-center justify-center text-gray-400 hover:text-primary hover:border-primary/50 hover:scale-110 transition-all">
