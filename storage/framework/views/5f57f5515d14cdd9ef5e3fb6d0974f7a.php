...
<?php $__env->startSection('title', 'Layanan Desain Interior - Home Putra Interior'); ?>
...
<div class="pt-24 sm:pt-32 pb-16 sm:pb-24 bg-background-dark min-h-screen relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-12 sm:mb-16">
            ...
            $delay = ($index % 3) * 100;
            ?>
            <div class="group" data-aos="fade-up" data-aos-delay="<?php echo e($delay); ?>">
                <div class="h-full p-6 sm:p-8 bg-white/5 border border-white/10 rounded-2xl hover:border-primary/30 hover:bg-white/8 transition-all duration-300">
                    ...
                    <div class="w-14 h-14 sm:w-16 sm:h-16 rounded-xl <?php echo e($color[0]); ?> flex items-center justify-center mb-4 sm:mb-6 group-hover:scale-110 transition-transform duration-300">
                        <span class="material-symbols-outlined <?php echo e($color[1]); ?> text-2xl sm:text-3xl"><?php echo e($service->icon ?? $icons[$index % count($icons)]); ?></span>
                    </div>

                    
                    <span class="text-white/10 text-5xl sm:text-6xl font-bold absolute top-4 right-4 group-hover:text-primary/10 transition-colors">0<?php echo e($index + 1); ?></span>

                    
                    <h3 class="text-lg sm:text-xl text-white font-semibold mb-2 sm:mb-3 group-hover:text-primary transition-colors"><?php echo e($service->title); ?></h3>
                    ...
                    <a href="<?php echo e(route('home')); ?>#contact" class="inline-flex items-center gap-2 text-primary text-sm font-medium group-hover:gap-3 transition-all">
            ...
            ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
            $colors = [
            ['bg-primary/20', 'text-primary'],
            ['bg-blue-500/20', 'text-blue-400'],
            ...
            $delay = ($index % 3) * 100;
            ?>
            <div class="group relative" data-aos="fade-up" data-aos-delay="<?php echo e($delay); ?>">
                <div class="h-full p-6 sm:p-8 bg-white/5 border border-white/10 rounded-2xl hover:border-primary/30 hover:bg-white/8 transition-all duration-300">

                    <div class="w-14 h-14 sm:w-16 sm:h-16 rounded-xl <?php echo e($color[0]); ?> flex items-center justify-center mb-4 sm:mb-6 group-hover:scale-110 transition-transform duration-300">
                        <span class="material-symbols-outlined <?php echo e($color[1]); ?> text-2xl sm:text-3xl"><?php echo e($service['icon']); ?></span>
                    </div>
        ...
        <div class="mb-12 sm:mb-16" data-aos="fade-up">
            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
                ...
                <div class="text-center group" data-aos="fade-up" data-aos-delay="<?php echo e($loop->index * 100); ?>">
                    <div class="relative inline-flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-white/5 border border-white/10 mb-3 sm:mb-4 group-hover:border-primary/30 group-hover:bg-primary/10 transition-all duration-300">
                        <span class="material-symbols-outlined text-primary text-2xl sm:text-3xl"><?php echo e($step['icon']); ?></span>
                        <span class="absolute -bottom-1 -right-1 w-6 h-6 sm:w-7 sm:h-7 bg-primary rounded-full flex items-center justify-center text-black text-xs font-bold"><?php echo e($step['num']); ?></span>
                    </div>
                    <h4 class="text-white font-semibold text-sm sm:text-base mb-1 group-hover:text-primary transition-colors"><?php echo e($step['title']); ?></h4>
                    <p class="text-gray-500 text-xs sm:text-sm"><?php echo e($step['desc']); ?></p>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
            ...
            <div class="relative p-6 sm:p-10 lg:p-12 rounded-2xl bg-white/5 border border-white/10 overflow-hidden">
                ...
                <div class="relative z-10 text-center max-w-2xl mx-auto">
                    ...
                    <div class="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
                        <a href="<?php echo e(route('home')); ?>#contact" class="inline-flex items-center justify-center gap-2 px-6 sm:px-8 py-3 sm:py-4 bg-primary hover:bg-primary-hover text-black font-bold rounded-xl transition-all">
                            <span class="material-symbols-outlined">chat</span>
                            <span>Konsultasi Gratis</span>
                        </a>
                        <a href="<?php echo e(route('home')); ?>#calculator" class="inline-flex items-center justify-center gap-2 px-6 sm:px-8 py-3 sm:py-4 bg-white/5 border border-white/20 text-white font-bold rounded-xl hover:bg-white/10 transition-all">
...
<?php echo $__env->make('frontend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\homeputra-laravel\resources\views/frontend/services-all.blade.php ENDPATH**/ ?>