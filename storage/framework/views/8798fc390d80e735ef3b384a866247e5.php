...
<?php $__env->startSection('title', 'Tambah Portfolio Baru'); ?>
<?php $__env->startSection('page-title', 'Portfolio / Tambah Baru'); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="group">
                        ...
                        <textarea name="description" rows="5"
                            ...
                            placeholder="Jelaskan detail project, tantangan, dan solusi yang diberikan..."><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="date" name="completion_date" value="<?php echo e(old('completion_date')); ?>"
            ...
            <div class="flex items-center gap-4 pt-4">
                <a href="<?php echo e(route('admin.portfolio.index')); ?>" class="px-6 py-3 rounded-xl bg-white/5 border border-white/10 text-gray-300 font-bold hover:bg-white/10 transition-colors">
                    Batal
                </a>
...
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="text-red-400 text-xs mt-2 text-center"><?php echo e($message); ?></p> <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\homeputra-laravel\resources\views/admin/portfolio/create.blade.php ENDPATH**/ ?>