...
<?php $__env->startSection('page-title', 'Pesan Masuk / Detail'); ?>
    ...
    <div class="glass-card rounded-2xl border border-white/5 overflow-hidden">
            ...
            <div class="flex items-start justify-between gap-4">
                <div class="flex items-center gap-4">
                    <div class="w-14 h-14 rounded-full bg-linear-to-br from-blue-500 to-cyan-600 flex items-center justify-center text-white font-bold text-2xl shadow-lg shadow-blue-500/20">
                        <?php echo e($message->initials); ?>

                    </div>
                    <div>
                        <h1 class="text-xl font-bold text-white mb-1"><?php echo e($message->service_type ?? 'Pesan Umum'); ?></h1>
                        <div class="flex items-center gap-2 text-sm text-gray-400">
                            <span class="font-medium text-gray-300"><?php echo e($message->full_name); ?></span>
                ...
                <div class="text-right">
                    <p class="text-sm font-medium text-gray-300"><?php echo e($message->created_at->translatedFormat('l, d F Y')); ?></p>
                    <p class="text-xs text-gray-500"><?php echo e($message->created_at->format('H:i')); ?> WIB</p>
                </div>
            </div>
        </div>
        ...
        <div class="p-6 bg-black/20 border-b border-white/5 grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
            <div>
                ...
                <span class="text-white font-mono"><?php echo e($message->phone ?? '-'); ?></span>
            </div>
            <div>
        ...
        <div class="p-6 border-t border-white/5 bg-white/2 flex items-center justify-between">
            <a href="<?php echo e(route('admin.messages.index')); ?>" class="px-4 py-2 rounded-lg hover:bg-white/5 text-gray-400 hover:text-white transition-colors flex items-center gap-2 text-sm font-bold">
            ...
            <div class="flex items-center gap-3">
                ...
                ?>
                <a href="https://wa.me/<?php echo e($phone); ?>?text=<?php echo e($waMessage); ?>"
                    target="_blank"
                ...
                <a href="mailto:<?php echo e($message->email); ?>?subject=Re: <?php echo e($message->service_type ?? 'Pesan'); ?>" class="px-5 py-2 bg-blue-600 hover:bg-blue-500 text-white font-bold rounded-lg shadow-lg shadow-blue-500/20 transition-all flex items-center gap-2">
                    <span class="material-symbols-outlined">reply</span>
                    Balas Email
                </a>

                <button type="button"
                    onclick="openDeleteModal('<?php echo e($message->id); ?>', '<?php echo e($message->full_name); ?>')"
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\homeputra-laravel\resources\views/admin/messages/show.blade.php ENDPATH**/ ?>