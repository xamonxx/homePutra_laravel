...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
    <div class="glass-card p-6 rounded-2xl border border-white/5 bg-green-500/5 relative overflow-hidden group">
        ...
        <div class="relative z-10">
            <h3 class="text-3xl font-bold text-white mb-1"><?php echo e($services->total() ?? 0); ?></h3>
    ...
    <div class="md:col-span-2 glass-card p-6 rounded-2xl border border-white/5 flex flex-col justify-center items-start">
        ...
        <a href="<?php echo e(route('admin.services.create')); ?>" class="px-5 py-2.5 bg-primary hover:bg-primary-dark text-black font-bold rounded-xl shadow-lg shadow-primary/20 hover:shadow-primary/40 hover:-translate-y-1 transition-all flex items-center gap-2">
        ...
        <table class="w-full text-left border-collapse">
            ...
            <tbody class="divide-y divide-white/5 text-sm">
                ...
                <tr class="group hover:bg-white/2 transition-colors">
                    ...
                    <td class="p-6">
                        <div class="flex items-center gap-4">
                            <div class="w-12 h-12 bg-green-500/10 rounded-xl flex items-center justify-center border border-green-500/20 group-hover:border-green-500/50 transition-all duration-500">
                                <span class="material-symbols-outlined text-green-400 text-2xl group-hover:scale-110 transition-transform"><?php echo e($item->icon); ?></span>
                            </div>
                            <div>
                                <h4 class="font-bold text-white group-hover:text-primary transition-colors text-base"><?php echo e($item->title); ?></h4>
                                <p class="text-xs text-gray-500 mt-0.5 font-mono"><?php echo e($item->icon); ?></p>
                            </div>
                        </div>
                    </td>
                    ...
                    <td class="p-6 text-center">
                        <span class="inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-full text-xs font-bold <?php echo e($item->is_active ? 'bg-green-500/10 text-green-400 border border-green-500/20' : 'bg-red-500/10 text-red-400 border border-red-500/20'); ?>">
                    ...
                    <td class="p-6">
                        <div class="flex items-center justify-end gap-2">
                            <a href="<?php echo e(route('admin.services.edit', $item->id)); ?>" class="p-2 rounded-lg text-blue-400 hover:bg-blue-500/10 hover:text-blue-300 transition-colors" title="Edit">
                ...
                <tr>
                    <td colspan="5" class="p-12 text-center">
                        <div class="flex flex-col items-center justify-center text-gray-500">
                            ...
                            <a href="<?php echo e(route('admin.services.create')); ?>" class="px-5 py-2 bg-primary text-black font-bold rounded-lg hover:bg-primary-dark transition-colors">
                                + Tambah Baru
                            </a>
                        </div>
                    </td>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\homeputra-laravel\resources\views/admin/services/index.blade.php ENDPATH**/ ?>