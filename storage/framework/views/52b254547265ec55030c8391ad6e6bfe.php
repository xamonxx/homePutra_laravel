...
<div class="space-y-8">
    ...
    <div class="bg-[#12141A] border border-white/5 rounded-2xl overflow-hidden">
        <div class="relative h-64 bg-cover bg-center"
            style="background-image: url('<?php echo e($hero->background_url); ?>');">
            ...
            <div class="relative z-10 p-8 flex flex-col justify-center h-full max-w-xl">
                ...
                <p class="text-gray-300 text-sm line-clamp-2"><?php echo e($hero->subtitle); ?></p>
            </div>
            <div class="absolute top-4 right-4 z-20">
                <span class="px-3 py-1 rounded-full text-xs font-bold <?php echo e($hero->is_active ? 'bg-green-500/20 text-green-400' : 'bg-red-500/20 text-red-400'); ?>">
                    <?php echo e($hero->is_active ? 'Aktif' : 'Tidak Aktif'); ?>
    ...
    <form action="<?php echo e(route('admin.hero.update')); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
        <?php echo csrf_field(); ?>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="bg-[#12141A] border border-white/5 rounded-2xl p-6 space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="title" value="<?php echo e(old('title', $hero->title)); ?>"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="title_highlight" value="<?php echo e(old('title_highlight', $hero->title_highlight)); ?>"
                ...
                <div>
                    ...
                    <textarea name="subtitle" rows="4"
                        ...
                        placeholder="Deskripsi singkat yang menarik..."><?php echo e(old('subtitle', $hero->subtitle)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="flex items-center justify-between p-4 bg-white/5 rounded-xl">
                    ...
                    <label class="relative inline-flex items-center cursor-pointer">
                        <input type="checkbox" name="is_active" value="1" class="sr-only peer" <?php echo e($hero->is_active ? 'checked' : ''); ?>>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-[#12141A] border border-white/5 rounded-2xl p-6 space-y-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="button1_text" value="<?php echo e(old('button1_text', $hero->button1_text)); ?>"
                        ...
                        <div>
                            ...
                            <input type="text" name="button1_link" value="<?php echo e(old('button1_link', $hero->button1_link)); ?>"
                                class="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:border-primary/50 transition-all"
                        ...
                        <div>
                            ...
                            <input type="text" name="button2_text" value="<?php echo e(old('button2_text', $hero->button2_text)); ?>"
                                class="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:border-primary/50 transition-all"
                        ...
                        <div>
                            ...
                            <input type="text" name="button2_link" value="<?php echo e(old('button2_link', $hero->button2_link)); ?>"
                                class="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:border-primary/50 transition-all"
                ...
                <div class="bg-[#12141A] border border-white/5 rounded-2xl p-6 space-y-6">
                    ...
                    <div class="relative aspect-video rounded-xl overflow-hidden bg-black/50">
                        <img src="<?php echo e($hero->background_url); ?>" alt="Hero Background" class="w-full h-full object-cover">
                    ...
                    <div>
                        ...
                        <input type="url" name="background_url" value="<?php echo e(filter_var($hero->background_image, FILTER_VALIDATE_URL) ? $hero->background_image : ''); ?>"
                            class="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:border-primary/50 transition-all"
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\homeputra-laravel\resources\views/admin/hero/index.blade.php ENDPATH**/ ?>