...
<section class="py-16 sm:py-20 md:py-28 lg:py-36 bg-background-dark relative overflow-hidden" id="contact">
    ...
    <div class="max-w-[1200px] mx-auto px-4 sm:px-6 relative z-10">
                    ...
                    <div class="grid lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 xl:gap-16">
                        ...
                        <div class="order-2 lg:order-1">
                            ...
                            <div class="space-y-3 sm:space-y-4">
                                <a href="https://wa.me/<?php echo e($whatsappNumber); ?>" class="group flex items-center gap-3 sm:gap-4 p-3 sm:p-4 md:p-5 bg-linear-to-br from-white/6 to-transparent border border-gray-700/50 rounded-xl sm:rounded-2xl cursor-pointer hover:border-primary/50 transition-all duration-300">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <p class="text-gray-500 text-xs sm:text-sm truncate">+<?php echo e($whatsappNumber); ?></p>
                                    </div>
                                ...
                                <a href="mailto:<?php echo e($contactEmail); ?>" class="group flex items-center gap-3 sm:gap-4 p-3 sm:p-4 md:p-5 bg-linear-to-br from-white/6 to-transparent border border-gray-700/50 rounded-xl sm:rounded-2xl cursor-pointer hover:border-primary/50 transition-all duration-300">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <p class="text-gray-500 text-xs sm:text-sm truncate"><?php echo e($contactEmail); ?></p>
                                    </div>
                                    <span class="material-symbols-outlined text-gray-600 text-lg sm:text-xl group-hover:text-primary group-hover:translate-x-1 transition-all shrink-0">arrow_forward</span>
                                </a>
                                ...
                                <div class="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 md:p-5 bg-linear-to-br from-white/6 to-transparent border border-gray-700/50 rounded-xl sm:rounded-2xl">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <p class="text-gray-500 text-xs sm:text-sm"><?php echo e($contactAddress); ?></p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mt-6 sm:mt-8 md:mt-10">
                                ...
                                <div class="flex items-center gap-2 sm:gap-3">
                                    ...
                                    <a href="<?php echo e($settings['instagram_url']); ?>" target="_blank" class="w-9 sm:w-10 md:w-11 h-9 sm:h-10 md:h-11 rounded-lg sm:rounded-xl bg-white/5 border border-gray-700/50 flex items-center justify-center text-gray-400 hover:text-primary hover:border-primary/50 hover:scale-110 transition-all">
                                        <span class="material-symbols-outlined text-base sm:text-lg md:text-xl">photo_camera</span>
                                    </a>
                                    <?php endif; ?>
                                    <?php if(!empty($settings['facebook_url'])): ?>
                                    <a href="<?php echo e($settings['facebook_url']); ?>" target="_blank" class="w-9 sm:w-10 md:w-11 h-9 sm:h-10 md:h-11 rounded-lg sm:rounded-xl bg-white/5 border border-gray-700/50 flex items-center justify-center text-gray-400 hover:text-primary hover:border-primary/50 hover:scale-110 transition-all">
                                        <span class="material-symbols-outlined text-base sm:text-lg md:text-xl">thumb_up</span>
                                    </a>
                                    <?php endif; ?>
                                    <?php if(!empty($settings['youtube_url'])): ?>
                                    <a href="<?php echo e($settings['youtube_url']); ?>" target="_blank" class="w-9 sm:w-10 md:w-11 h-9 sm:h-10 md:h-11 rounded-lg sm:rounded-xl bg-white/5 border border-gray-700/50 flex items-center justify-center text-gray-400 hover:text-primary hover:border-primary/50 hover:scale-110 transition-all">
                            ...
                            <form id="contact-form" class="space-y-4 sm:space-y-5">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                                    <div class="space-y-1.5 sm:space-y-2">
                                        ...
                                        <input name="first_name" class="w-full bg-background-dark border border-gray-700/50 rounded-lg sm:rounded-xl px-3 sm:px-4 py-3 sm:py-4 text-white focus:border-primary focus:ring-0 outline-none text-sm placeholder-gray-600 transition-all" placeholder="John" type="text" required />
                                    </div>
                                    <div class="space-y-1.5 sm:space-y-2">
                                        <label class="text-gray-400 text-[11px] sm:text-xs font-medium">Nama Belakang</label>
                                        <input name="last_name" class="w-full bg-background-dark border border-gray-700/50 rounded-lg sm:rounded-xl px-3 sm:px-4 py-3 sm:py-4 text-white focus:border-primary focus:ring-0 outline-none text-sm placeholder-gray-600 transition-all" placeholder="Doe" type="text" />
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                                    <div class="space-y-1.5 sm:space-y-2">
                                        ...
                                        <input name="email" class="w-full bg-background-dark border border-gray-700/50 rounded-lg sm:rounded-xl px-3 sm:px-4 py-3 sm:py-4 text-white focus:border-primary focus:ring-0 outline-none text-sm placeholder-gray-600 transition-all" placeholder="john@example.com" type="email" required />
                                    </div>
                                    <div class="space-y-1.5 sm:space-y-2">
                                        <label class="text-gray-400 text-[11px] sm:text-xs font-medium">Telepon</label>
                                        <input name="phone" class="w-full bg-background-dark border border-gray-700/50 rounded-lg sm:rounded-xl px-3 sm:px-4 py-3 sm:py-4 text-white focus:border-primary focus:ring-0 outline-none text-sm placeholder-gray-600 transition-all" placeholder="+62 812 xxx xxxx" type="tel" />
                                    </div>
                                </div>
                                ...
                                <div class="space-y-1.5 sm:space-y-2">
                                    ...
                                    <select name="service_type" class="w-full bg-background-dark border border-gray-700/50 rounded-lg sm:rounded-xl px-3 sm:px-4 py-3 sm:py-4 text-white focus:border-primary focus:ring-0 outline-none text-sm transition-all appearance-none cursor-pointer" style="background-image: url('data:image/svg+xml;charset=UTF-8,%3csvg xmlns=%27http://www.w3.org/2000/svg%27 viewBox=%270 0 24 24%27 fill=%27none%27 stroke=%27%236b7280%27 stroke-width=%272%27 stroke-linecap=%27round%27 stroke-linejoin=%27round%27%3e%3cpolyline points=%276 9 12 15 18 9%27%3e%3c/polyline%3e%3c/svg%3e'); background-repeat: no-repeat; background-position: right 1rem center; background-size: 1em;">
                                ...
                                <div class="space-y-1.5 sm:space-y-2">
                                    ...
                                    <textarea name="message" class="w-full bg-background-dark border border-gray-700/50 rounded-lg sm:rounded-xl px-3 sm:px-4 py-3 sm:py-4 text-white focus:border-primary focus:ring-0 outline-none text-sm placeholder-gray-600 resize-none transition-all" placeholder="Ceritakan tentang proyek Anda..." rows="3"></textarea>
                                </div>
        ...
        <div class="mt-8 sm:mt-10 md:mt-12 text-center" data-aos="fade-up" data-aos-delay="200">
            ...
            <a href="https://wa.me/<?php echo e($whatsappNumber); ?>" class="inline-flex items-center gap-2 sm:gap-3 px-5 sm:px-6 md:px-8 py-3 sm:py-4 bg-green-500 hover:bg-green-600 text-white rounded-lg sm:rounded-xl font-bold text-xs sm:text-sm uppercase tracking-wider transition-all hover:shadow-xl hover:shadow-green-500/30 group">
...
<script>
    document.getElementById('contact-form').addEventListener('submit', function(e) {
        ...
        // Kirim data ke API
        fetch('<?php echo e(route("api.contact.store")); ?>', {
                method: 'POST',
                headers: {
...
</script><?php /**PATH C:\laragon\www\homeputra-laravel\resources\views/frontend/partials/contact.blade.php ENDPATH**/ ?>